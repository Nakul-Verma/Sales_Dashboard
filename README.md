...
We used a lot of sales data for this project, including what products we sold who our customersre how different regions are doing and how much money we made. We cleaned up the data using Power Query fixed any mistakes and made sure it was ready to use. We also made a plan for how all the data fits so it is easy to look at and understand.

The Sales Dashboard has interactive things like cards that show important numbers, bar charts, line charts, maps and pie charts. These help us see the picture of our sales how much money we made what products are doing well and how our customers are behaving. We can also use filters to look at things and drill down to get more details.

We did some calculations to figure out important things like how much profit we made how we are doing compared to last year and what our customers are worth to us. These calculations help us see what is working well and what needs to be improved.
